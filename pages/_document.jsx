    ...
    return (
      <Html>
        <Head>
          ...
          <meta property="og:title" content="Frex Bot" />
          <link
            rel="icon"
            href="/img/logo2.png"
            type="image/x-icon"
          ...
          <meta
            ...
            content="Frex botu profesyonel sunucular için en iyi seçimdir. Birbirinden güzel komutları ile kullanıcılarına kolaylık sağlar."
          />
