  ...
  return (
    <>
      ...
      <img width="500" src="/img/bck.png" />
       ...
       Do you want a nice moderation bot on your server? then WhyAoi.js is for you! Try and see :)
	  </p>
...
Vote WhyAoi.js?</a>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-12 lg:gap-y-0 lg:gap-x-12 py-24">
          <div className="col-span-4">
            <p className="text-white text-4xl font-bold" dangerouslySetInnerHTML={{ __html:"WhyAoi.js? Bot" }} />
            ...
            <a href="https://bit.ly/3PHDjyC" className={"mt-10 flex items-center px-4 justify-center gap-x-2 shadow-lg shadow-amber-600/20 cursor-pointer rounded-xl py-4 font-medium bg-gradient-to-r from-amber-700 to-amber-500 hover:opacity-80 transition duration-200 text-white"}>
              <i className="fab fa-discord mr-2" />Invite WhyAoi.js
            </a>
          </div>
          ...
          <div className="col-span-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div>
                <div className="text-white">
                  ...
                  <p className="text-gray-500 line-clamp-4">with fast and adjustable settings spefic your server | (WhyAoi.js gives you a safe environment!)</p>
                </div>
              </div>
              <div>
                <div className="text-white">
                  <p className="text-xl font-semibold mt-5"><i className={`fa fa-universal-access text-2xl text-amber-500`} /> Universal</p>
                  <p className="text-gray-500 line-clamp-4">The bot has moderation settings for your entire server! | (Invite WhyAoi.js!)>
                </div>
              </div>
          </div>
      </div>
