...
{/*  </Link>*/}
      ...
      {/*      <p className="text-white text-4xl font-bold" dangerouslySetInnerHTML={{ __html:"DD Master" }} />*/}
      ...
      {/*      <a href="https://discord.com/oauth2/authorize?client_id=1255576744577208401" className={"mt-10 flex items-center px-4 justify-center gap-x-2 shadow-lg shadow-amber-600/20 cursor-pointer rounded-xl py-4 font-medium bg-gradient-to-r from-amber-700 to-amber-500 hover:opacity-80 transition duration-200 text-white"}>*/}
      {/*        <i className="fab fa-discord mr-2" />Invite DD Master*/}
      {/*      </a>*/}
      {/*    </div>*/}
      ...
      {/*            <p className="text-gray-500 line-clamp-4">With fast and customizable settings specific to your server, DD Master gives you a musical pleasure to the fullest.</p>*/}
      {/*          </div>*/}
      {/*        </div>*/}
      {/*        <div>*/}
      {/*          <div className="text-white">*/}
